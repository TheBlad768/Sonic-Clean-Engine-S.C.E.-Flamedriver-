...
"%AS_MSGPATH%/p2bin.exe" -p=FF -z=0,kosinski-optimised,Size_of_Snd_driver_guess,after Sonic.p Sonic.gen Sonic.h
IF EXIST Sonic.p del Sonic.p
IF EXIST Sonic.h del Sonic.h
...
"AS/Windows/convsym.exe" Sonic.lst Sonic.gen -a -input as_lst -exclude -filter "z[A-Z].+"
